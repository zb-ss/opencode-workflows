...
const HARD_DENIES: readonly PermissionRule[] = [
  ...
  { permission: 'epic_budget_update', pattern: '*', action: 'deny' },
  { permission: 'epic_budget_extend', pattern: '*', action: 'deny' },
  { permission: 'epic_start', pattern: '*', action: 'deny' },
  { permission: 'epic_pause', pattern: '*', action: 'deny' },
  { permission: 'epic_cancel', pattern: '*', action: 'deny' },
  { permission: 'epic_resume', pattern: '*', action: 'deny' },
  { permission: 'epic_redelegate', pattern: '*', action: 'deny' },
  { permission: 'epic_integrate', pattern: '*', action: 'deny' },
  { permission: 'epic_cleanup', pattern: '*', action: 'deny' },
  { permission: 'queue_enqueue', pattern: '*', action: 'deny' },
